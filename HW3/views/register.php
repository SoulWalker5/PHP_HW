    ...
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column justify-content-center">
        ...
        <form name="registerUser" method="POST">
            ...
            <div class="form-input">
                ...
                <input type="text" name="firstname" class="form-control" required placeholder="Enter your name">
            </div>
            <div class="form-input">
                <i class="fa fa-lock"></i>
                <input type="password" name="password" class="form-control" required placeholder="Password">
            </div>
            <button class="btn btn-primary mt-4 signup" type="submit">Register now</button>
        </form>
